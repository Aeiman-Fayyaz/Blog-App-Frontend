...
const BlogDetail = () => {
  ...
  if (!blog)
    return (
      <div className="text-center py-24 text-mutedText">Article not found.</div>
    );
...
return (
  <div className="max-w-4xl mx-auto px-4 sm:px-6 py-10 space-y-10">
    ...
    <header className="space-y-4">
      ...
      <p className="text-md text-text dark:text-accent">{blog.description}</p>
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center text-xs text-accent space-x-3 mt-0.5">
              ...
              <span className="flex items-center">
                <Clock className="w-3.5 h-3.5 mr-1" /> {blog.readTime} min read
              </span>
            </div>
          </div>
        </div>
      ...
      <aside className="hidden lg:col-span-4 lg:flex flex-col space-y-8 text-left self-start sticky top-28">
        ...
        <div className="bg-surface/50 dark:bg-dark-surface/20 border border-border/40 dark:border-dark-border/40 p-6 rounded-3xl space-y-4 text-center">
          ...
          <p className="text-xs text-mutedText leading-relaxed text-left mb-3">
            Love this story? Support the writer by saving it to your bookmarks,
            liking it, or sharing it with your followers.
          </p>
